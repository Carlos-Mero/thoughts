...
$$ 
\begin{aligned}
\nabla_\theta \mathcal{J}_{\text{GRPO}} (\theta) &= \mathbb{E}_{\mathbf{x} \sim \mathcal{D}, \mathbf{y} \sim \mu_{\theta_{\text{old}}} (\cdot | \mathbf{x})} [\frac{1}{|\mathbf{y}|} \sum_{t=1}^{|\mathbf{y}|} (\mathbf{y}, \mathbf{x}) A (\mathbf{x}, \mathbf{y}) \nabla_\theta r_t (\mathbf{y}, \mathbf{x})] \\
\nabla_\theta \mathcal{J}_{\text{token}} (\theta) &= \mathbb{E}_{\mathbf{x} \sim \mathcal{D}, \mathbf{y} \sim \mu_{\theta_{\text{old}}} (\cdot | \mathbf{x})} [\sum_{t=1}^{|\mathbf{y}|} (\mathbf{y}, \mathbf{x}) A (\mathbf{x}, \mathbf{y}) \nabla_\theta r_t (\mathbf{y}, \mathbf{x})]
\end{aligned} 
$$
